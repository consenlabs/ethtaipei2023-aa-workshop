...
library InitCodeLib {
    function pack(address factory, uint256 salt, address owner) internal pure returns (bytes memory) {
        // TODO: Implement this method to pass the tests in test/InitCode.t.sol
        //
        // With account factory, we can deploy account simultaneously in first user operation.
        // Please implement this method to deploy `SampleAccount` through `SampleAccountFactory`.
        //
        // HINT:
